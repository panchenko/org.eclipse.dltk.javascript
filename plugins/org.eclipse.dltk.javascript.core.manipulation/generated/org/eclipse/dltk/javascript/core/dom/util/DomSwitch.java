 ...
 * </copyright>
 *
 * $Id: DomSwitch.java,v 1.1 2010/11/08 00:20:22 apanchenk Exp $
 */
...
public class DomSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DomPackage.MUTLI_LINE_COMMENT: {
				MutliLineComment mutliLineComment = (MutliLineComment)theEObject;
				T result = caseMutliLineComment(mutliLineComment);
				if (result == null) result = caseComment(mutliLineComment);
				if (result == null) result = caseNode(mutliLineComment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomPackage.SINGLE_LINE_COMMENT: {
				SingleLineComment singleLineComment = (SingleLineComment)theEObject;
				T result = caseSingleLineComment(singleLineComment);
				if (result == null) result = caseComment(singleLineComment);
				if (result == null) result = caseNode(singleLineComment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DomPackage.EXPRESSION_STATEMENT: {
				...
				if (result == null) result = caseIForInitializer(expressionStatement);
			...
			case DomPackage.CONTINUE_STATEMENT: {
				...
				if (result == null) result = caseISelector(continueStatement);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mutli Line Comment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mutli Line Comment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMutliLineComment(MutliLineComment object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Single Line Comment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Single Line Comment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSingleLineComment(SingleLineComment object) {
		return null;
	}
