 ...
 * <ul>
 *   <li>{@link org.eclipse.dltk.javascript.internal.model.references.impl.TypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.dltk.javascript.internal.model.references.impl.TypeImpl#getMembers <em>Members</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeImpl extends EObjectImpl implements Type {
	...
	protected EClass eStaticClass() {
		return ReferenceModelPackage.Literals.TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceModelPackage.TYPE__NAME, oldName, name));
	}
	...
	public EList<Member> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Member>(Member.class, this, ReferenceModelPackage.TYPE__MEMBERS);
		}
		return members;
	}
