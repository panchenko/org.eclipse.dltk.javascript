...
public class JSParser extends Parser {
    ...
    // $ANTLR start keyword
    // JS.g:637:1: keyword : ( BREAK | CASE | CATCH | CONTINUE | DEFAULT | DELETE | DO | ELSE | FINALLY | FOR | EACH | FUNCTION | GET | SET | IF | IN | INSTANCEOF | NEW | RETURN | SWITCH | THIS | THROW | TRY | TYPEOF | VAR | VOID | WHILE | WITH | NAMESPACE | XML | YIELD );
    public final keyword_return keyword() throws RecognitionException {
        ...
        try {
            // JS.g:638:2: ( BREAK | CASE | CATCH | CONTINUE | DEFAULT | DELETE | DO | ELSE | FINALLY | FOR | EACH | FUNCTION | GET | SET | IF | IN | INSTANCEOF | NEW | RETURN | SWITCH | THIS | THROW | TRY | TYPEOF | VAR | VOID | WHILE | WITH | NAMESPACE | XML | YIELD )
            // JS.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    public final namespaceStatement_return namespaceStatement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: StringLiteral, ASSIGN, WXML, DEFAULT
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final functionExpression_return functionExpression() throws RecognitionException {
        ...
        try {
            ...
            match(input,FUNCTION,FOLLOW_FUNCTION_in_functionExpression6426); 
            ...
            switch (alt75) {
                case 1 :
                    // JS.g:1731:17: name= identifier
                    {
                    pushFollow(FOLLOW_identifier_in_functionExpression6430);
                    name=identifier();
                    _fsp--;
            ...
            pushFollow(FOLLOW_formalParameterList_in_functionExpression6433);
            formalParameterList314=formalParameterList();
            _fsp--;

            stream_formalParameterList.add(formalParameterList314.getTree());
            pushFollow(FOLLOW_functionBody_in_functionExpression6435);
    ...
    public final formalParameterList_return formalParameterList() throws RecognitionException {
        ...
        try {
            ...
            match(input,LPAREN,FOLLOW_LPAREN_in_formalParameterList6463); 
            ...
            switch (alt77) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_identifier_in_formalParameterList6469);
                    args=identifier();
                    _fsp--;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    match(input,COMMA,FOLLOW_COMMA_in_formalParameterList6473); 
                    	    stream_COMMA.add(COMMA317);

                    	    pushFollow(FOLLOW_identifier_in_formalParameterList6477);
                    	    args=identifier();
                    	    _fsp--;
            ...
            match(input,RPAREN,FOLLOW_RPAREN_in_formalParameterList6485); 
    ...
    public final functionBody_return functionBody() throws RecognitionException {
        ...
        try {
            ...
            {
            lb=(Token)input.LT(1);
            match(input,LBRACE,FOLLOW_LBRACE_in_functionBody6511); 
            stream_LBRACE.add(lb);
            ...
            do {
            	...
            	case 1 :
            	    // JS.g:1741:14: sourceElement
            	    {
            	    pushFollow(FOLLOW_sourceElement_in_functionBody6513);
            ...
            match(input,RBRACE,FOLLOW_RBRACE_in_functionBody6516); 
    ...
    public final getMethodDeclaration_return getMethodDeclaration() throws RecognitionException {
        ...
        try {
            ...
            match(input,GET,FOLLOW_GET_in_getMethodDeclaration6546); 
            ...
            match(input,LPAREN,FOLLOW_LPAREN_in_getMethodDeclaration6552); 
            stream_LPAREN.add(LPAREN322);

            RPAREN323=(Token)input.LT(1);
            match(input,RPAREN,FOLLOW_RPAREN_in_getMethodDeclaration6554); 
            stream_RPAREN.add(RPAREN323);

            pushFollow(FOLLOW_functionBody_in_getMethodDeclaration6556);
    ...
    public final setMethodDeclaration_return setMethodDeclaration() throws RecognitionException {
        ...
        try {
            ...
            match(input,SET,FOLLOW_SET_in_setMethodDeclaration6584); 
            ...
            match(input,LPAREN,FOLLOW_LPAREN_in_setMethodDeclaration6590); 
            stream_LPAREN.add(LPAREN326);

            pushFollow(FOLLOW_identifier_in_setMethodDeclaration6594);
            param=identifier();
            _fsp--;

            stream_identifier.add(param.getTree());
            RPAREN327=(Token)input.LT(1);
            match(input,RPAREN,FOLLOW_RPAREN_in_setMethodDeclaration6596); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // JS.g:1765:4: sourceElement
            	    {
            	    pushFollow(FOLLOW_sourceElement_in_program6633);
            ...
            match(input,EOF,FOLLOW_EOF_in_program6636); 
        ...
        try {
            ...
            switch (alt80) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_functionDeclaration_in_sourceElement6665);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_statement_in_sourceElement6670);
    ...
    public static final BitSet FOLLOW_LPAREN_in_parenExpression3542 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LBRACK_in_arrayLiteral3571 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819804D40L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COMMA_in_arrayLiteral3579 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819804D40L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_nameValuePair3720 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_arguments3816 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800740L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COMMA_in_arguments3824 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LBRACK_in_leftHandSideExpression3913 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_DOTDOT_in_leftHandSideExpression3962 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLONCOLON_in_leftHandSideExpression3983 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_unaryOperator_in_unaryExpression4126 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_multiplicativeExpression4282 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_additiveExpression4319 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_shiftExpression4353 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_relationalExpression4391 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_relationalExpressionNoIn4436 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_equalityExpression4482 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_set_in_equalityExpressionNoIn4519 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_AND_in_bitwiseANDExpression4562 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_AND_in_bitwiseANDExpressionNoIn4583 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_XOR_in_bitwiseXORExpression4606 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_XOR_in_bitwiseXORExpressionNoIn4629 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_OR_in_bitwiseORExpression4651 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_OR_in_bitwiseORExpressionNoIn4673 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LAND_in_logicalANDExpression4699 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LAND_in_logicalANDExpressionNoIn4720 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LOR_in_logicalORExpression4742 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LOR_in_logicalORExpressionNoIn4764 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_QUE_in_conditionalExpression4790 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_conditionalExpression4795 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_QUE_in_conditionalExpressionNoIn4816 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_conditionalExpressionNoIn4821 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_assignmentOperator_in_assignmentExpression4859 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_assignmentOperator_in_assignmentExpressionNoIn4947 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COMMA_in_expression4976 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COMMA_in_expressionNoIn5021 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LBRACE_in_block5228 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x00000018198025C0L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_statement_in_block5230 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x00000018198025C0L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_ASSIGN_in_variableDeclaration5302 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_ASSIGN_in_variableDeclarationNoIn5324 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_ifStatement5426 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RPAREN_in_ifStatement5430 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_statement_in_ifStatement5432 = new BitSet(new long[]{0x0000000000004002L});
    public static final BitSet FOLLOW_ELSE_in_ifStatement5438 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_DO_in_doStatement5500 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_doStatement5506 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_whileStatement5540 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RPAREN_in_whileStatement5545 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_forEachStatement5567 = new BitSet(new long[]{0x0000006E72461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RPAREN_in_forEachStatement5571 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_forStatement5621 = new BitSet(new long[]{0x0000006E72461070L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RPAREN_in_forStatement5626 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_IN_in_forControlVar5675 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_SEMIC_in_forControlVar5730 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_SEMIC_in_forControlVar5737 = new BitSet(new long[]{0x0000006E52461072L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_IN_in_forControlExpression5822 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_expression_in_forControlExpression5826 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEMIC_in_forControlExpression5872 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_SEMIC_in_forControlExpression5879 = new BitSet(new long[]{0x0000006E52461072L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_expression_in_forControlExpression5883 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEMIC_in_forControlSemic5942 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_SEMIC_in_forControlSemic5949 = new BitSet(new long[]{0x0000006E52461072L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RETURN_in_returnStatement6061 = new BitSet(new long[]{0x0000006E52461070L,0x00000018198025C0L,0x1C506C0000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_withStatement6089 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_RPAREN_in_withStatement6094 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_switchStatement6120 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_CASE_in_caseClause6172 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_caseClause6177 = new BitSet(new long[]{0x0000106FFFCF3CF2L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_statement_in_caseClause6180 = new BitSet(new long[]{0x0000106FFFCF3CF2L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_defaultClause6196 = new BitSet(new long[]{0x0000106FFFCF3CF2L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_statement_in_defaultClause6199 = new BitSet(new long[]{0x0000106FFFCF3CF2L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_COLON_in_labelledStatement6218 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_statement_in_labelledStatement6220 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_THROW_in_throwStatement6251 = new BitSet(new long[]{0x0000006E52461070L,0x0000001819800540L,0x1C50600000000000L,0x0000000000000040L});
    ...
    public static final BitSet FOLLOW_FUNCTION_in_functionExpression6426 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000100L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_functionExpression6430 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
    public static final BitSet FOLLOW_formalParameterList_in_functionExpression6433 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_functionBody_in_functionExpression6435 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_formalParameterList6463 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000200L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_formalParameterList6469 = new BitSet(new long[]{0x0000000000000000L,0x0000000000004200L});
    public static final BitSet FOLLOW_COMMA_in_formalParameterList6473 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000000L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_formalParameterList6477 = new BitSet(new long[]{0x0000000000000000L,0x0000000000004200L});
    public static final BitSet FOLLOW_RPAREN_in_formalParameterList6485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LBRACE_in_functionBody6511 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x00000018198025C0L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_sourceElement_in_functionBody6513 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x00000018198025C0L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_RBRACE_in_functionBody6516 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_GET_in_getMethodDeclaration6546 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000000L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_getMethodDeclaration6550 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
    public static final BitSet FOLLOW_LPAREN_in_getMethodDeclaration6552 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_RPAREN_in_getMethodDeclaration6554 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_functionBody_in_getMethodDeclaration6556 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SET_in_setMethodDeclaration6584 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000000L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_setMethodDeclaration6588 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
    public static final BitSet FOLLOW_LPAREN_in_setMethodDeclaration6590 = new BitSet(new long[]{0x0000006600020000L,0x0000000000000000L,0x0010000000000000L});
    public static final BitSet FOLLOW_identifier_in_setMethodDeclaration6594 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_RPAREN_in_setMethodDeclaration6596 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_functionBody_in_setMethodDeclaration6598 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_sourceElement_in_program6633 = new BitSet(new long[]{0x0000106FFFCF3CF0L,0x0000001819802540L,0x1C50600000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_EOF_in_program6636 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_functionDeclaration_in_sourceElement6665 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_statement_in_sourceElement6670 = new BitSet(new long[]{0x0000000000000002L});
